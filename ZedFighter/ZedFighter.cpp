...
JetFighterGame::JetFighterGame() {
	cout << "Welcome to ZedFighter\nWASD to move player\nUse Mouse to aim\nHold left click to shoot\nSurvive Up to round 5!\nTip:To beat the Mutant(big zombie dude) hide behind wall and wait for him to shoot\n\nNote: If Enemies get stuck in walls/Car, move off screen and they will come to you";
}
